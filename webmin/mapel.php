                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Data Mata Pelajaran<span> | TP <?php echo $data_tp['KETERANGAN'] ?></span></h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmts = $con->query("SELECT * FROM ref_mapel ORDER BY KDMAPEL ASC");
                                            while ($data = $stmts->fetch_array()) {
                                                echo "<tr><th scope='row'>" . $data['KDMAPEL'] . "</th>
                                                <td>" . $data['NAMA_MAPEL'] . "</td>
                                                <td>" . $data['RINGKAS'] . "</td>
                                                ";
                                                echo  "<td><a href='mapel_edit.php?id=" . $data['KDMAPEL'] . "' class='badge bg-success'>ubah</a></td></tr>";
                                            }
                                            ?>
