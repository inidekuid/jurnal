                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Data Siswa<span> | TP <?php echo $data_tp['KETERANGAN'] ?></span></h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmts = $con->query("SELECT * FROM siswa ORDER BY NAMASISWA ASC");
                                            $i = 1;
                                            while ($data = $stmts->fetch_array()) {
                                                ...
                                                ";
                                                echo  "<td><a href='siswa_edit.php?id=" . $data['NISN'] . "' class='badge bg-success'>ubah</a></td></tr>";
                                            }
                                            ?>
