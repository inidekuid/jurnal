                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Data Kelas<span> | TP <?php echo $data_tp['KETERANGAN'] ?></span></h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmts = $con->query("SELECT * FROM ref_kelas ORDER BY NAMA_KELAS ASC");
                                            while ($data = $stmts->fetch_array()) {
                                                echo "<tr><th scope='row'>" . $data['KD_KELAS'] . "</th>
                                                <td>" . $data['NAMA_KELAS'] . "</td>
                                                ";
                                                echo  "<td><a href='rombel_edit.php?id=" . $data['KD_KELAS'] . "' class='badge bg-success'>ubah</a></td></tr>";
                                            }
                                            ?>
