                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Data Jurnal<span> | TP <?php echo $data_tp['KETERANGAN'] ?></span></h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
											...
											WHERE kg.IDTP='" . $data_tp['IDTP'] . "' ORDER BY kg.TANGGAL ASC");
                                            while ($data = $stmts->fetch_array()) {
                                                echo "<tr><th scope='row'>" . tgl_indo($data['TANGGAL']) . "</th>
