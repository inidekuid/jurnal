                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Data Pengguna<span> | TP <?php echo $data_tp['KETERANGAN'] ?></span></h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmts = $con->query("SELECT * FROM pengguna ORDER BY NAMAPENGGUNA ASC");
                                            $i = 1;
                                            while ($data = $stmts->fetch_array()) {
                                                ...
                                                echo  "<td><a href='user_edit.php?id=" . $data['IDP'] . "' class='badge bg-success'>ubah</a></td></tr>";
                                            }
                                            ?>
